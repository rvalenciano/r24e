...
RSpec.describe UserSessionsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all user_sessions as @user_sessions" do
      ...
      expect(assigns(:user_sessions)).to eq([user_session])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created user_session as @user_session" do
        ...
        expect(assigns(:user_session)).to be_persisted
      end

      it "redirects to the created user_session" do
        post :create, {:user_session => valid_attributes}, valid_session
        expect(response).to redirect_to(UserSession.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved user_session as @user_session" do
        post :create, {:user_session => invalid_attributes}, valid_session
        expect(assigns(:user_session)).to be_a_new(UserSession)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested user_session" do
        user_session = UserSession.create! valid_attributes
        put :update, {:id => user_session.to_param, :user_session => new_attributes}, valid_session
        user_session.reload
    ...
    context "with invalid params" do
      it "assigns the user_session as @user_session" do
        user_session = UserSession.create! valid_attributes
        put :update, {:id => user_session.to_param, :user_session => invalid_attributes}, valid_session
        expect(assigns(:user_session)).to eq(user_session)
      end
